    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                Console.WriteLine($"{divdend} / {divisor} = {Divide(divdend, divisor)}");
            }
            ...
            {
                Console.WriteLine($"0으로 나누기 예외 발생 : {ex.Message}");
            }
            catch (Exception ex)
            {
        ...
        private static object Divide(int divisor, int divdend)
        {
            ...
            if (divdend == 0) throw new DivideByZeroException("피제수가 0이 입력 되었습니다"); 
