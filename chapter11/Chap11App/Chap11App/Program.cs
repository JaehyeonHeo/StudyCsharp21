...
namespace Chap11App
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            float[] source3 = { 1.1f, 2.2f, 3.3f, 4.5f, 6.4f };
            float[] target3 = new float[source3.Length];

            CoppyArray(source3, target3);
            Console.WriteLine("float 복사");
            foreach (float item in source3)
            {
                Console.WriteLine(item); 
            }
        ...
        private static void CoppyArray(float[] source3, float[] target3)
        {
        ...
        private static void CoppyArray(string[] source2, string[] target2)
        {
        ...
        private static void CoppyArray(int[] source, int[] target)
        {
